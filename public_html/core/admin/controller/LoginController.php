...
class LoginController extends \core\base\controller\BaseController
{
	...
	protected function inputData()
	{
		...
		// после выполнения метода 1-ый раз (1-ый вход на странцу авторизации), автоматически будут созданы 2-е таблицы в БД: blocked_access и users Метод: setAdmin() расположен по адресу: core\base\model\UserModel.php (имя, логин, пароль для входа в админку в нём будут записаны в таблицу: users)
		$this->model->setAdmin();
